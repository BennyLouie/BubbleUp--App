...
jasmine_vb = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: vivis_b.id)
jasmine_vc = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: vivis_c.id)
jasmine_kb = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: kft_b.id)
jasmine_kc = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: kft_c.id)
jasmine_gm = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: gongcha_m.id)
jasmine_gb = Tea.create(name: "Jasmine Tea", price: 4.5, shop_id: gongcha_b.id)
earl = Tea.create(name: "Earl Grey Tea", price: 4.0, shop_id: vivis_b.id)
three_j = Tea.create(name: "3 J's Tea", price: 4.5, shop_id: vivis_c.id)
honeydew = Tea.create(name: "Honeydew Milk Tea", price: 4.5, shop_id: vivis_b.id)
mango = Tea.create(name: "Mango Slush", price: 4.25, shop_id: kft_b.id)
milk = Tea.create(name: "Plain Milk Tea", price: 3.25, shop_id: gongcha_b.id)
redbean = Tea.create(name: "Red Bean Slush", price: 4.5, shop_id: kft_c.id)
herbal = Tea.create(name: "Milk Tea w/ Herbal Jelly", price: 4.5, shop_id: gongcha_m.id)
lemon_kc = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: kft_c.id)
lemon_kb = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: kft_b.id)
lemon_vc = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: vivis_c.id)
lemon_vb = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: vivis_b.id)
lemon_gm = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: gongcha_m.id)
lemon_gb = Tea.create(name: "Honey Lemon Tea", price: 3.75, shop_id: gongcha_b.id)
...
Recommendation.create(user_id: kenneth.id, tea_id: lemon_gm.id, comments: "Delicious!!!")
